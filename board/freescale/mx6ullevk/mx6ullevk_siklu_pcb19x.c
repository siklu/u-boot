...
#define KERNEL_ADDR_STR      "83000000"   // address to copy kernel from uimage
#define KERNEL_ADDR_HEX     0x83000000   // address where booter founds the kernel (same above)

#define RAMD_ADDR           0x84100000 // address to copy RAMD from uimage

...
static struct serdes_map board_serdes_map[] = {
	...
	{PEX2, SERDES_SPEED_5_GBPS, PEX_ROOT_COMPLEX_X1, 1, 1},
};
...
{
	/* Configure MPP */
	writel(0x10111111, MVEBU_MPP_BASE + 0x00);
	writel(0x11111111, MVEBU_MPP_BASE + 0x04);
	writel(0x55400011, MVEBU_MPP_BASE + 0x08);
	writel(0x25053353, MVEBU_MPP_BASE + 0x0c);
	writel(0x45455555, MVEBU_MPP_BASE + 0x10);
	writel(0x01144565, MVEBU_MPP_BASE + 0x14);
	writel(0x40033333, MVEBU_MPP_BASE + 0x18);
...
int board_init(void)
{
	...
	/* Set MPP47 high to deassert PCIe1,2 reset */
	setbits_le32(MVEBU_GPIO1_BASE + 0x0, BIT(15));
	clrbits_le32(MVEBU_GPIO1_BASE + 0x4, BIT(15));

...
#define N366_HW_REVISION_GPIO_NAME_BIT_2 	"cps_gpio06"   //  cps bank 0 gpio 6  (CP1_MPP[6])
#define N366_HW_REVISION_GPIO_NAME_BIT_3 	"cpm_gpio07"   //  cpm bank 0 gpio 7  (CP1_MPP[7])
